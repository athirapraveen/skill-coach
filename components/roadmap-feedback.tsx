...
export function RoadmapFeedback({ roadmapId, roadmapTitle, keepCount, onRegenerateRoadmap }: RoadmapFeedbackProps) {
    ...
    <Card className="border border-gray-200 shadow-md hover:shadow-lg transition-all duration-300 rounded-xl overflow-hidden">
      <CardHeader className="bg-white border-b border-gray-100">
        ...
        <CardDescription className="text-gray-600">
          {keepCount > 0 ? (
            <>You've marked <span className="font-semibold text-blue-600">{keepCount} topics</span> to keep. All other topics may be refined based on your feedback.</>
          ) : (
            "Use the 'Keep' button to preserve topics you like, then provide feedback to refine your roadmap."
          )}
        </CardDescription>
      </CardHeader>
